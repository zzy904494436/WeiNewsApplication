...
public class CommonAdapter extends FragmentPagerAdapter {
    ...
    public CommonAdapter(FragmentManager fm, List<Fragment> listFragments) {
        super(fm);
        this.listFragments = listFragments;
    }

    public CommonAdapter(FragmentManager fm, List<Map<String, Object>> listTitles, List<Fragment> listFragments) {
        super(fm);
